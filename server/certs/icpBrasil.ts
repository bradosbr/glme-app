/**
 * Raiz da ICP-Brasil usada pelos webservices das SEFAZ (ex.: nfe.sefaz.pe.gov.br,
 * emitido pela AC SERPRO SSLv1, subordinada a esta raiz). O Node não traz a ICP-Brasil
 * no repositório de confiança padrão, então ela é somada às raízes do Node.
 *
 * Fonte oficial: https://acraiz.icpbrasil.gov.br/credenciadas/RAIZ/ICP-Brasilv10.crt
 * (repositório do ITI). Conferida em 18/09/2026 contra a cadeia apresentada pela SEFAZ-PE.
 * Titular: CN=Autoridade Certificadora Raiz Brasileira v10
 * Válida até: Jul  1 12:00:59 2032 GMT
 * SHA-256: 6E:0B:FF:06:9A:26:99:4C:15:DE:2C:48:88:CC:54:AF:84:88:2E:54:95:B7:FB:F6:6B:E9:CC:FF:EC:74:89:F6
 */
export const ICP_BRASIL_RAIZ_V10 = `-----BEGIN CERTIFICATE-----
